...
export async function initializeBarferPrices() {
    try {
        const defaultPrices = [
            ...
            { section: 'OTROS' as PriceSection, product: 'BOX DE COMPLEMENTOS', weight: null, priceType: 'EFECTIVO' as PriceType, price: 0 },
            { section: 'OTROS' as PriceSection, product: 'BOX DE COMPLEMENTOS', weight: null, priceType: 'TRANSFERENCIA' as PriceType, price: 0 },
            { section: 'OTROS' as PriceSection, product: 'BOX DE COMPLEMENTOS', weight: null, priceType: 'MAYORISTA' as PriceType, price: 0 },
